...
passport.use(
  new GooglePlusTokenStrategy(
    {
      clientID: process.env.GOOGLE_CLIENT_ID || "12345678",
      clientSecret: process.env.GOOGLE_CLIENT_SECRET || "12345678",
    },
...
passport.use(
  new FacebookTokenStrategy(
    {
      clientID: process.env.FACEBOOK_CLIENT_ID || "12345678",
      clientSecret: process.env.FACEBOOK_CLIENT_SECRET || "12345678",
      fbGraphVersion: 'v3.0',
    },
    function (accessToken, refreshToken, profile, done) {
      try {
